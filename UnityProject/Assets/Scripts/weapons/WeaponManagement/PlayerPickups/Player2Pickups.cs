...
public class Player2Pickups : MonoBehaviour
{
    ...
    //to check if the player is player controlled or ai controlled
    Player player;
    ...
    private void Start()
    {
        gameController = GameObject.FindGameObjectWithTag("Player2Weapons");
