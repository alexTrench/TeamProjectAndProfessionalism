...
public class HealthHandler : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playersMaxHealth[cPlayerIndex] != uMaxPlayerHealth)
        {
            playersMaxHealth[cPlayerIndex] = uMaxPlayerHealth;
            if (!charactersManager.GetPlayerByIndex(cPlayerIndex).IsDead())
            {
                healthSystem.setHealth(cPlayerIndex);
        ...
        {
            healthSystem.setHealth(playersHealth[cPlayerIndex]);
        }
